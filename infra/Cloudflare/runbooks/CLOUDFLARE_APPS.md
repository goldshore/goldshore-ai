...
- For GitHub Actions worker deploy jobs (`deploy-gs-api.yml`, `deploy-gs-agent.yml`, `deploy-gs-gateway.yml`, `deploy-gs-control.yml`, `deploy-banproof-me.yml`), use only:
