...
const tok = requiredEnv('CLOUDFLARE_BUILD_API_TOKEN', 'CF_API_TOKEN');
const acc = requiredEnv('CLOUDFLARE_ACCOUNT_ID', 'CF_ACCOUNT_ID');
const zone = requiredEnv('CLOUDFLARE_ZONE_ID', 'CF_ZONE_ID');
