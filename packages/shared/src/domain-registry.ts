...
export const DOMAIN_REGISTRY: DomainRegistryEntry[] = [
  ...
  { hostname: 'admin.goldshore.ai', role: 'admin', repo: 'marzton/goldshore-ai', appOrWorker: 'gs-admin', ownerType: 'pages', canonical: false, notes: 'Cloudflare Access required' },
