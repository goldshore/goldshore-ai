...
| `.github/workflows/cloudflare-infra-guard.yml` | Validate Cloudflare Workers/Pages infrastructure wiring and guardrails for incident triage. | `pull_request`, `workflow_dispatch` | **Blocking** |
